...
<body class="bg-gray-100 flex h-screen antialiased overflow-hidden">
    ...
    <aside class="w-64 bg-black text-white flex flex-col shadow-2xl flex-shrink-0 transition-all duration-300">
        ...
        <div class="py-8 flex flex-col items-center justify-center border-b border-gray-800 px-4">
            ...
            <div class="flex flex-col items-center text-center">
                ...
                <span class="text-xs text-blue-400 font-medium mt-1">Sistem Penugasan</span>
            </div>
        </div>
        ...
        <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
            ...
            <a href="{{ route('admin.penugasan.index') }}"
                class="flex items-center px-4 py-3 rounded-lg transition-colors duration-200 {{ request()->routeIs('admin.penugasan.*') ? 'bg-blue-600 text-white shadow-md' : 'text-gray-300 hover:bg-gray-900 hover:text-yellow-400' }}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="{{ route('admin.user.index') }}"
                 class="flex items-center px-4 py-3 rounded-lg transition-colors duration-200 {{ request()->routeIs('admin.user.*') ? 'bg-blue-600 text-white shadow-md' : 'text-gray-300 hover:bg-gray-900 hover:text-yellow-400' }}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <footer class="bg-white border-t border-gray-200 p-4 text-center text-sm text-gray-500 shadow-inner">
            &copy; {{ date('Y') }} Sistem Penugasan. Dikembangkan oleh Tim IT.
        </footer>
