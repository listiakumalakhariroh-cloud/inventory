...
<body class="bg-gray-100 flex h-screen antialiased overflow-hidden">
    ...
    <aside class="w-64 bg-gray-900 text-white flex flex-col shadow-lg flex-shrink-0">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
            ...
            <a href="{{ route('admin.dashboard') }}" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition-colors {{ request()->routeIs('admin.dashboard') ? 'bg-gray-800 text-white border-l-4 border-blue-500' : '' }}">
            ...
            <a href="{{ route('admin.pengaduan') }}" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition-colors {{ request()->routeIs('admin.pengaduan') ? 'bg-gray-800 text-white border-l-4 border-blue-500' : '' }}">
        ...
        <header class="h-16 bg-white shadow-sm flex items-center justify-between px-6 z-10">
            ...
            <div class="relative flex items-center space-x-4">
                ...
                <button id="profileBtn" class="flex items-center focus:outline-none">
                    <div class="w-9 h-9 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 border-2 border-transparent hover:border-blue-300 transition">
                ...
                <div id="dropdownMenu" class="hidden absolute right-0 top-10 mt-2 w-48 bg-white rounded-md shadow-lg py-1 text-gray-700 border border-gray-100">
                    <a href="{{ route('dashboard') }}" class="block px-4 py-2 text-sm hover:bg-gray-50 transition border-b border-gray-50">Lihat Web User</a>
