                ...
                <h2 class="text-2xl font-bold text-gray-900 flex items-center">
                    <svg class="w-7 h-7 mr-2 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M12 4v1m6 11h2m-6 0h-8v4h8v-4zm-4-8h4v4H8V8zM5 8H3m2 6H3"></path>
                    </svg>
            ...
            <div
                ...
                <div class="flex flex-wrap w-full xl:w-auto items-center justify-start xl:justify-end gap-2">
                    <a href="{{ route('admin.penugasan.template') }}"
                        class="bg-gray-800 border border-emerald-500/50 text-emerald-400 px-3 py-2 rounded-lg hover:bg-gray-700 hover:text-emerald-300 text-xs font-bold flex items-center transition shadow-sm">
                        <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path>
                        </svg> Template
                    </a>
                    <a href="{{ route('admin.penugasan.export') }}"
                        class="bg-gray-800 border border-amber-500/50 text-amber-400 px-3 py-2 rounded-lg hover:bg-gray-700 hover:text-amber-300 text-xs font-bold flex items-center transition shadow-sm">
                        <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('admin.penugasan.create') }}"
                        class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 text-xs font-bold flex items-center transition shadow-sm transform hover:scale-105 ml-1">
                    ...
                    <tbody class="divide-y divide-gray-100 text-gray-700">
                        @forelse ($penugasan as $p)
                            <tr class="hover:bg-blue-50/50 transition-colors group">
                                <td class="px-6 py-4">
                                    <span
                                        class="px-2 py-1 bg-gray-100 border border-gray-200 text-blue-600 font-mono text-xs font-bold rounded shadow-sm">
                                        {{ $p->kodetugas }}
                                    </span>
                                </td>
                                ...
                                <td class="px-6 py-4 text-xs font-semibold text-gray-800">
                                    @if ($p->anggota->count() > 0)
                                        <div class="flex items-center">
                                            <svg class="w-4 h-4 text-gray-400 mr-1.5" fill="none"
                                            ...
                                            @if ($p->anggota->count() > 1)
                                                <span
                                                    class="ml-2 px-1.5 py-0.5 bg-gray-200 text-gray-600 rounded-md font-mono text-[10px] shadow-inner">
                                                    +{{ $p->anggota->count() - 1 }}
                                                </span>
                                            @endif
                                        </div>
                                ...
                                <td class="px-6 py-4">
                                    <span
                                        class="px-2 py-1 text-[10px] font-bold rounded tracking-wider shadow-sm {{ $p->status_penugasan_class }}">
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center text-gray-500">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <span class="text-sm font-semibold">Belum ada data penugasan yang ditugaskan kepada
                                            user.</span>
                                    </div>
                                </td>
                            </tr>
