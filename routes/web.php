...
Route::middleware(['auth'])->group(function () {
    ...
    // Route di bawah ini disiapkan untuk fungsionalitas tombol selanjutnya (bisa di-uncomment nanti)
    // Route::get('/admin/tugas/tambah', [TugasController::class, 'create'])->name('admin.tugas.create');
    // Route::post('/admin/tugas/simpan', [TugasController::class, 'store'])->name('admin.tugas.store');
